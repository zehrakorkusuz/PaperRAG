...
class BaseEmbeddingModel:
    ...
    def generate_audio_embeddings(self, audio_paths: List[str]) -> np.ndarray:
        """
    ...
    def generate_video_embeddings(self, video_paths: List[str]) -> np.ndarray:
        """
        Generate embeddings for a list of video file paths.

        :param video_paths: List of video file paths to generate embeddings for.
        :return: Numpy array of video embeddings.
        """
        logger.debug("generate_video_embeddings called with video_paths: %s", video_paths)
        raise NotImplementedError("This method should be overridden.")

    def generate_tabular_embeddings(self, data: np.ndarray) -> np.ndarray:
        """
        Generate embeddings for tabular data.

        :param data: Numpy array of tabular data to generate embeddings for.
        :return: Numpy array of tabular data embeddings.
        """
        logger.debug("generate_tabular_embeddings called with data shape: %s", data.shape)
        raise NotImplementedError("This method should be overridden.")
